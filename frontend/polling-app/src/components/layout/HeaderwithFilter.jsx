...
const HeaderwithFilter = ({ title, filterType, setFilterType }) => {
  ...
  return (
    ...
    <div className="flex items-center justify-between">
      ...
      <button 
      className={`flex items-center gap-3 text-sm text-white bg-cyan-500 px-4 py-2
      ...
      >
        ...
        {open && (
            <div className="flex flex-wrap gap-4 bg-cyan-500 p-4 rounded-l-lg rounded-b-lg">
