...
const PollOptionVoteResult = ({ label, optionVotes, totalVotes }) => {
  ...
  return (
    <div className="w-full bg-slate-200/80 rounded-md relative mb-3">
      <div
...
const ImagePollResult = ({ totalVotes, optionVotes, imgUrl }) => {
  return (
    <div>
...
const PollResultContent = ({ type, options, voters, responses }) => {
  switch (type) {
    case "single-choice":
    case "yes/no":
    case "rating":
